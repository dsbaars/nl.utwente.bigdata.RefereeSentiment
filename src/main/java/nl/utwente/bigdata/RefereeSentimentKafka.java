 ...
 * @package Assignment7 
 */
public class RefereeSentimentKafka extends AbstractTopologyRunnerNimbus {   
	final String[] languages = new String[]{ "en", "es", "fr", "it", "de", "nl"};
	public static final Logger logger = Logger.getLogger(RefereeSentimentKafka.class);  
	...
	protected StormTopology buildTopology(Properties properties) {
		...
		builder.setSpout("tweetsText", new KafkaSpout(kafkaConf), 1);
...
//			; 
			...
			FileNameFormat fileNameFormat = new DefaultFileNameFormat()
				.withPath(String.format("/user/s1017497/s1017497-referee-sentiment-real-%s/", lang));
    ...
    public static void main(String[] args) {
    	new RefereeSentimentKafka().run(args);;
    }
}
