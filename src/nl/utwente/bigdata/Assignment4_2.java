...
public class Assignment4_2 extends AbstractTopologyRunner {   
	...
	protected StormTopology buildTopology(Properties properties) {
		...
		// TODO: add topology generation for assignment 4.2 here. Especially add the 
		// completed TopCounterBolt
		String boltId = "";
		String prevId;
		...
		boltId = "counter"; 
		builder.setBolt(boltId, new TopCounterBolt()).addConfiguration(Config.TOPOLOGY_TICK_TUPLE_FREQ_SECS, 30).shuffleGrouping(prevId);
		prevId = boltId;
