...
public class GetMatchesBoltTest {
	...
	public void testMatchMatcher() {
	    ...
	    bolt.execute(generateTestTuple(tweetJson, "en", testCreatedAt));

		assertEquals("Iran", col.output.get(0).get(2));
	}
		
	@SuppressWarnings("rawtypes")
	private Tuple generateTestTuple(String tweet,  String lang, String createdAt) {
